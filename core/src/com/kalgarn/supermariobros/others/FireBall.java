package com.kalgarn.supermariobros.others;
...
public class FireBall extends Sprite {
    ...
    public FireBall(PlayScreen screen, float x, float y, boolean fireRight){
        ...
        setBounds(x, y, 6 / SuperMarioBros.PPM, 6 / SuperMarioBros.PPM);
        defineFireBall();
    }

    public void defineFireBall(){
        BodyDef bdef = new BodyDef();
        bdef.position.set(fireRight ? getX() + 12 /SuperMarioBros.PPM : getX() - 12 /SuperMarioBros.PPM, getY());
        ...
        shape.setRadius(3 / SuperMarioBros.PPM);
        fdef.filter.categoryBits = SuperMarioBros.FIREBALL_BIT;
